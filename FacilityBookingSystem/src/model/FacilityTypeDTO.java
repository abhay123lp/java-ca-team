...
public class FacilityTypeDTO implements Cloneable, Serializable {
    ...
    public FacilityTypeDTO (int typeIDIn) {
    ...
    public boolean hasEqualMapping(FacilityTypeDTO valueObject) {
    ...
    public Object clone() {
        FacilityTypeDTO cloned = new FacilityTypeDTO();
