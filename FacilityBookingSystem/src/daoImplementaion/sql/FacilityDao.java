...

{
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, FacilityDTO valueObject) 
          throws NotFoundException, SQLException {
    ...
    protected List<FacilityDTO> listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
