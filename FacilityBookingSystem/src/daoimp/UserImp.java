...
public class UserImp extends BaseConnection implements UserDAO{
	...
	public void load(User user) throws NotFoundException,
			SQLException {
	...
	public List<User> getAllUser() throws SQLException {
		...
		List<User> searchResults = listQuery(conn.prepareStatement(sql));
	...
	public List<User> searchMatching(User user)
			throws SQLException {
		...
		if (user.getUserID() != null) {
			...
			sql.append("AND UserID LIKE '").append(user.getUserID())
					.append("%' ");
		}
		...
		if (user.getUserName() != null) {
			...
			sql.append("AND UserName LIKE '").append(user.getUserName())
					.append("%' ");
		}
		...
		if (user.getUserPSW() != null) {
			...
			sql.append("AND UserPSW LIKE '").append(user.getUserPSW())
					.append("%' ");
		}
		...
		if (user.getContactNo() != null) {
			...
			sql.append("AND ContactNo LIKE '").append(user.getContactNo())
					.append("%' ");
		}
	...
	protected void singleQuery(PreparedStatement stmt,
			User user) throws NotFoundException, SQLException {
	...
	protected List<User> listQuery(PreparedStatement stmt)
			throws SQLException {
