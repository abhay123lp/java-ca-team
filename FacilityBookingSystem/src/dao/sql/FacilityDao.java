...
public class FacilityDao {
    ...
    /* getObject-method */
    public Facility getObject(Connection conn, String facID) throws NotFoundException, SQLException {
    ...
    public void load(Connection conn, Facility valueObject) throws NotFoundException, SQLException {
          ...
          String sql = "SELECT * FROM javaca WHERE (FacID = ? ) "; 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM javaca ORDER BY FacID ASC ";
    ...
    public synchronized void create(Connection conn, Facility valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO javaca ( FacID, FacName, FacUsage, "
               + "TypeID) VALUES (?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);
    ...
    public void save(Connection conn, Facility valueObject) 
          throws NotFoundException, SQLException {

          String sql = "UPDATE javaca SET FacName = ?, FacUsage = ?, TypeID = ? WHERE (FacID = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void delete(Connection conn, Facility valueObject) 
          throws NotFoundException, SQLException {
          ...
          String sql = "DELETE FROM javaca WHERE (FacID = ? ) ";
          PreparedStatement stmt = null;
    ...
    public List searchMatching(Connection conn, Facility valueObject) throws SQLException {
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Facility valueObject) 
          throws NotFoundException, SQLException {
