...
public class FacilityTypeDaoImpl  implements  FacilityTypeDAO{
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, FacilityTypeDTO valueObject) 
          throws NotFoundException, SQLException {
    ...
    protected List<FacilityTypeDTO> listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
