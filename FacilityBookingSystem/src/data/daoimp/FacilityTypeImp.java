...
public class FacilityTypeImp extends BaseConnection implements FacilityTypeDAO {
    ...
    public FacilityType getFacilityType(int typeID) throws NotFoundException, SQLException {
    ...
    public void load(FacilityType facilityType) throws NotFoundException, SQLException {
    ...
    public void updateFacilityType(FacilityType facilityType) throws NotFoundException, SQLException {
    ...
    public void deleteFacilityType(FacilityType facilityType) throws NotFoundException, SQLException {
    ...
    public List<FacilityType> searchMatching(FacilityType facilityType) throws SQLException {
          ...
          if (facilityType.getTypeID() != 0) {
              ...
              sql.append("AND TypeID = ").append(facilityType.getTypeID()).append(" ");
          }

          if (facilityType.getTypeName() != null) {
              if (first) { first = false; }
              sql.append("AND TypeName LIKE '").append(facilityType.getTypeName()).append("%' ");
          }

          if (facilityType.getCapacity() != null) {
              if (first) { first = false; }
              sql.append("AND Capacity LIKE '").append(facilityType.getCapacity()).append("%' ");
          }

          if (facilityType.getDesicription() != null) {
              if (first) { first = false; }
              sql.append("AND Description LIKE '").append(facilityType.getDesicription()).append("%' ");
          }
    ...
    protected void singleQuery(PreparedStatement stmt, FacilityType facilityType) throws NotFoundException, SQLException {
    ...
    protected List<FacilityType> listQuery(PreparedStatement stmt) throws SQLException {
