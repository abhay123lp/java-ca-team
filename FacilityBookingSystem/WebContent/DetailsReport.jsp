...
<form action ="BookingItemsDetails" method ="post">
    ...
    <p class="style1"><u>User Details</u></p>
                ...
                <table style="width: 100%; height: 285px;">
                    <tr>
                        <td align="center" class="style21">
                            ...
                            <c:forEach var="date1" items= "${dateUsage}" varStatus="status">
                    ...
                    <tr>
                        <td>
                            <img src="<%= graphURL %>"width=500 height=300 border=0 usemap="#<%= filename %>"></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table style="width: 100%; height: 185px;">
                    <tr>
                        <td align="center" class="style22">
                            ...
                            <input id="Submit2" type="submit" value="submit" class="button"/></td>
                    </tr>
                    <tr>
                        <td class="style23">
                            </td>
                    ...
                    <br />
            	<input id="return" type="button" value="return" onclick = "re()" class="button"></td>
            </tr>
        </table>
    </p>
        <p>
