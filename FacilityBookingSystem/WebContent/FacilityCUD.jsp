...
<body>
	<div id="wrapper">
		...
		<div id="menu">
			<ul>
				<li class="first current_page_item"></a></li>
		...
		<a href="${url}"><fmt:message key="label.facility.add" /></a> <br />
		<br />
		<table class="borderAll">
			<tr>
				...
				<th><fmt:message key="label.facility.edit" /> <fmt:message
						key="label.facility.delete" /></th>
			</tr>
			<c:forEach var="facility" items="${facility}" varStatus="status">
				<tr class="${status.index%2==0?'even':'odd'}">
					...
					<td class="nowrap"><c:url var="updurl" scope="page"
						...
						</c:url> <a href="${updurl}"><fmt:message key="label.facility.edit" /></a>
						&nbsp;&nbsp;&nbsp; <c:url var="delurl" scope="page"
							value="/deleteFacility">
							<c:param name="FacID" value="${facility.facID}" />
						</c:url> <a href="${delurl}"><fmt:message key="label.facility.delete" /></a>
					</td>
				</tr>
			</c:forEach>
		</table>
