...
public class FacilityDTO implements Cloneable, Serializable {
    ...
    public FacilityDTO (String facIDIn) {
    ...
    public boolean hasEqualMapping(FacilityDTO valueObject) {
    ...
    public Object clone() {
        FacilityDTO cloned = new FacilityDTO();
